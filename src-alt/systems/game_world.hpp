...
namespace pd::systems
{
	...
	public:
		...
		[[nodiscard]] static auto get_last_frame_delta(entt::registry& registry) noexcept -> sf::Time;

		static auto set_frame_delta(entt::registry& registry, sf::Time this_frame_delta) noexcept -> void;

		[[nodiscard]] static auto get_total_elapsed(entt::registry& registry) noexcept -> sf::Time;

		static auto update_total_elapsed(entt::registry& registry, sf::Time this_frame_delta) noexcept -> void;

		[[nodiscard]] static auto get_play_elapsed(entt::registry& registry) noexcept -> sf::Time;

...
#include <components/entity/floor_decoration.hpp>
#include <components/entity/wall_decoration.hpp>
...
namespace pd::systems::helper
{
	...
	) noexcept -> entt::entity
	{
		...
		// physics
		{
			...
			shape_def.filter.maskBits = CollisionMask::floor_decoration;
			// 传感器

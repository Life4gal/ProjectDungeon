...
namespace pd::config
{
	namespace from_json
	{
		...
		extern auto load_tile_set(TileSet& tile_set, const ConfigReader::json_format& json) noexcept -> bool;

		[[nodiscard]] auto load_tile_set(TileSet& tile_set, const ConfigReader::json_format& json) noexcept -> bool
		{

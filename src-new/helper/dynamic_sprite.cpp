...
namespace pd::helper
{
	...
	auto DynamicSprite::get_next_frame_index(const FramesCount& frames_count, const Index& index, const Mode& mode, const Direction& direction) noexcept -> index_type
	{

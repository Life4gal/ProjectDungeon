...
namespace pd::helper
{
	...
	public:
		...
		[[nodiscard]] static auto get_next_frame_index(
			...
			const component::render::dynamic_sprite::Mode& mode,
			const component::render::dynamic_sprite::Direction& direction
		) noexcept -> index_type;
		...
		static auto set_mode(
			...
			component::render::dynamic_sprite::Mode mode
		) noexcept -> void;
		...
		[[nodiscard]] static auto get_mode(
			...
			entt::entity entity_with_animation
		) noexcept -> component::render::dynamic_sprite::Mode;
		...
		static auto set_direction(
			entt::registry& registry,
			entt::entity entity_with_animation,
			component::render::dynamic_sprite::Direction direction
		) noexcept -> void;
		...
		[[nodiscard]] static auto get_direction(
			const entt::registry& registry,
			entt::entity entity_with_animation
		) noexcept -> component::render::dynamic_sprite::Direction;
